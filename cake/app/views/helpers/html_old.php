 ...
 */
	function link($title, $url = null, $htmlAttributes = array(), $confirmMessage = false, $escapeTitle = true, $escapeConfirm = false) {
		if ($url !== null) {
			$url = $this->url($url);
		} else {
			$url = $this->url($title);
		...
		if ($confirmMessage) {
			...
			$confirmMessage = str_replace('"', '\"', $confirmMessage);
			$returnConfirm = "return confirm('{$confirmMessage}');";
			if ($escapeConfirm)
			{
        //$returnConfirm = "return confirm(\'{$confirmMessage}\');";
        ...
        $htmlAttributes['onclick'] = "return confirm('{$confirmMessage}');";
			...
			//$htmlAttributes['onclick'] = "return confirm(\'{$confirmMessage}\');";
      //$htmlAttributes['onclick'] = $returnConfirm;
